          ...
          <div class="dashboard__item__comments">
            ...
            <div class="dashboard__item__tags">
              <span
                ...
                class="tag tag--small"
              >{{ tag.name }}</span>
              <span class="type">{{ getTypeObj(reviews.type).name }}</span>
            </div>
          </div>
        </div>
      </div>
        ...
        <div class="dashboard__item__details">
          ...
          <div class="dashboard__item__tags">
            ...
            <span
              ...
              class="tag tag--small"
            >{{ tag.name }}</span>
            <span class="type">{{ getTypeObj(drafts.type).name }}</span>
          </div>
        </div>
      </div>
    </div>
          ...
          <div class="dashboard__item__details">
            ...
            <div class="dashboard__item__tags">
              ...
              <span
                ...
                class="tag tag--small"
              >{{ tag.name }}</span>
              <span class="type">{{ getTypeObj(published.type).name }}</span>
            </div>
          </div>
        </div>
      </div>
  ...
  <div class="dashboard__status">
    ...
    >
      ...
      <div class="dashboard__item__title">
        ...
        <div
          v-if="published.slug == 'disclaimer' || published.slug == 'home' || published.slug == 'impress'"
