...
>
   ...
   <div
     id="project__preview__trigger"
     class="ic preview"
     v-on:click="toggle('preview')"
     v-if="auth"
   ></div>
...
<!-- <transition name="slide-fade">
  ...
  <div id="project__type">
    ...
    <div id="project" class="site" >
      ...
      <div
        id="project__preview"
        v-bind:class="{'is-hidden': isHidden.preview }"
      >
        <div class="preview__wrapper">
          <exchange-page-project
            :project="project"
            :type="getTypeObj(project.type)"
          ></exchange-page-project>
        </div>

        <div class="modal__close" v-on:click="isHidden.preview = true"></div>
