     ...
     getTypeObj(id) {
      ...
      dropItem(index) {
        ...
        // if(this.itemId != '') {
          ...
          if(this.elemIndex == '') {
            if(this.itemId != '') {
              arr.splice(index + 1, 0, {'title': 'project', 'id': this.itemId, 'type_id': 20, 'link': this.itemLink, 'link_title': this.linkTitle })
            }
            if(this.tagId != '') {
              arr.splice(index + 1, 0, {'title': 'tag', 'id': this.tagId, 'type_id': 20, 'link': this.itemLink, 'link_title': this.linkTitle })
            }
