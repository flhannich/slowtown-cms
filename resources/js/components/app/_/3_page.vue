      ...
      <!-- <div class="group__header">
        ...
        <div class="wrapper">
          ...
          >
            ...
            <button class="ic__editor drag" v-on:click="pickItem(item.id, item.type_id, null, index)"></button>
            <!-- <button class="ic__editor edit" ><a :href="`/cms/project/${ group.slug }`"></a></button> -->
            <button class="ic__editor link" ></button>
            <button class="ic__editor delete" v-on:click="removeItem(index), itemControlIndex = '999'"></button>
            <div class="triangle"></div>
          </div>
        </div>
        <div
      ...
      >
        <div class="wrapper">
          ...
          >
            ...
            <button class="ic__editor drag" v-on:click="pickItem(null, item.type_id, item.tag_id, index)"></button>
            ...
            >
              <input type="text" placeholder="https://" v-model="item.type_link">
              <button class="ic__editor trash" v-on:click="item.type_link = ''"></button>
     ...
     getTypeObj(id) {
      ...
      dropItem(index) {
        ...
        // if(this.itemId != '') {
          ...
          if(this.elemIndex == '') {
            if(this.itemId != '') {
              arr.splice(index + 1, 0, {'title': 'project', 'id': this.itemId, 'type_id': 1})
            }
            if(this.tagId != '') {
              arr.splice(index + 1, 0, {'title': 'tag', 'id': this.tagId, 'type_id': 1})
            }
